...
DEFINE_double(simulation_time, 0.1, "Desired duration of the simulation [s].");
...
//                                   "ground_collision", rigid_hydro_props);
  ...
  owned_deformable_model->SetMpmGravity(Vector3<double>(0,0,0));
  owned_deformable_model->maniskill_params.num_mpm_substeps = 1;
  owned_deformable_model->maniskill_params.friction_mu = 0.0;
  owned_deformable_model->maniskill_params.friction_kf = 0.0;
  owned_deformable_model->maniskill_params.contact_damping = 0.0;
