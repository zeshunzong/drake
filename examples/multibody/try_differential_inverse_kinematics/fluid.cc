...
int do_main() {
  ...
  plant.RegisterCollisionGeometry(plant.world_body(), X_WG, skewed_pad,
                                  "skewed_pad", rigid_proximity_props);
  ...
  plant.RegisterCollisionGeometry(
      ...
      left_side_pad, "left_side_pad", rigid_proximity_props);
  plant.RegisterVisualGeometry(
  ...
  plant.RegisterCollisionGeometry(
      plant.world_body(), RigidTransformd(Eigen::Vector3d(0.2, 0, 0)),
      right_side_pad, "right_side_pad", rigid_proximity_props);
  plant.RegisterVisualGeometry(
      plant.world_body(), RigidTransformd(Eigen::Vector3d(0.20, 0, 0)),
