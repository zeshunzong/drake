...
void TestProjectPD(bool project) {
  ...
  particles.AddParticle(
      Vector3<double>(0.01, 0.01, 0.01), Vector3<double>(0.0, 0.0, 0.0),
      std::make_unique<StvkHenckyWithVonMisesModel<double>>(100.0, 0.2, 10.0),
      1.0, 1.0);

  particles.AddParticle(
      Vector3<double>(0.05, -0.05, 0.15), Vector3<double>(0.0, 0.0, 0.0),
      std::make_unique<StvkHenckyWithVonMisesModel<double>>(300.0, 0.2, 10.0),
      1.0, 1.0);

  particles.AddParticle(
      Vector3<double>(-1.2, 0.0, 0.4), Vector3<double>(0.0, 0.0, 0.0),
      std::make_unique<StvkHenckyWithVonMisesModel<double>>(500.0, 0.2, 10.0),
      1.0, 1.0);
