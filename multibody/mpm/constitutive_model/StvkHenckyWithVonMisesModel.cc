...
template <typename T>
StvkHenckyWithVonMisesModel<T>::StvkHenckyWithVonMisesModel(const T& E, const T& nu,
                                                         const T& tau_c):
...
template <typename T>
StvkHenckyWithVonMisesModel<T>::StvkHenckyWithVonMisesModel(const T& tau_c):
...
template <typename T>
void StvkHenckyWithVonMisesModel<T>::CalcFEFromFtrial(Matrix3<T>* F_trial) const {
...
template <typename T>
void StvkHenckyWithVonMisesModel<T>::CalcKirchhoffStress(const Matrix3<T>& FE, Matrix3<T>* tau) const {
...
template <typename T>
void StvkHenckyWithVonMisesModel<T>::CalcKirchhoffStressPrivate(
