...
void SparseGrid<T>::SortActiveNodes() {
  ...
  std::sort(active_nodes_.begin(), active_nodes_.end(),
            [](Vector3<int> node1_index_3d, Vector3<int> node2_index_3d) {
              return ((node1_index_3d(0) < node2_index_3d(0)) ||
                      ((node1_index_3d(0) == node2_index_3d(0)) &&
                       (node1_index_3d(1) < node2_index_3d(1))) ||
                      ((node1_index_3d(0) == node2_index_3d(0)) &&
                       (node1_index_3d(1) == node2_index_3d(1)) &&
                       (node1_index_3d(2) < node2_index_3d(2))));
            });
